...
<head>
    ...
    <title>List Redeem | The Company</title>
</head>
...
<body class="redeem">
                            ...
                            <div class="modinside">
                                <div id="HeaderBanner">
                                    <div class="bannerImage">
                                        <img src="<?= base_url() ?>images/header-redeem.jpg" />
                                    </div>
                                    <div class="page-header">
                                        <h2>TRANSAKSI REDEMPTION</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="divTableBody">
                                                <div class="divTableRow">
                                                    ...
                                                    <div class="divTableCell">
                                                        <div class="wrapBtn">
                                                            <div class="cellBtn"><a class="button">Redeem Baru</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($rows ?? [] as $k => $v) { ?>
                                                    <tr>
                                                        ...
                                                        <td data-label="Nilai Transaksi"><?= $v['order_amount'] ?></td>
                                                        <td data-label="Unit Transaksi"><?= $v['order_unit'] ?></td>
                                                        <td data-label="All Unit"><?= $v['order_by'] ?></td>
                                                        <td data-label="Status"><?= $v['status_code'] ?></td>
                                                        <td data-label="Nilai Net"><?= $v['trx_net'] ?></td>
    ...
    <section id="hidden-panel-2">
        <div class="inside">
            <div class="item-page">
                <div class="page-header">
                    <h3>FORM REDEMPTION</h3>
                </div>
                <div id="entryRedHead" class="divTable">
                    <div class="divTableBody">
                        <div class="divTableRow">
                            <div id="nasabahID" class="divTableCell">
                                <div class="IDnasabah">
                ...
                <form>
                    <input class="hide" type="text" name="client_id" id="client_id">
                    <input class="hide" type="text" name="identity_id" id="identity_id">
                    <div id="entryRedeem" class="divTable">
                        <div class="divTableBody">
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    <span class="control-label">
                                        <label class="ifua_id" for="ifua_id">IFUA: </label>
                                    </span>
                                    <span class="controls">
                                        <select name="ifua_id">
                                        </select>
                                ...
                                <div class="divTableCell">
                                    <div class="controls">
                                        <span class="radioinput">
                                            <input type="radio" value="1" name="order_by" id="rdNilaiRedemption">
                                            <label for="rdNilaiRedemption" class="radioBtn">Nilai Redemption: </label>
                                        </span>
                                        <input id="order_amount" class="inputRedeem" type="text" name="order_amount" disabled="disabled">
                                    </div>
                                    <div class="controls">
                                        <span class="radioinput">
                                            <input type="radio" value="2" name="order_by" id="rdUnitRedemption">
                                            <label for="rdUnitRedemption" class="radioBtn">Unit Redemption: </label>
                                        </span>
                                        <input id="order_unit" class="inputRedeem" type="text" name="order_unit" disabled="disabled">
                                    </div>
                                    <div class="controls">
                                        <span class="radioinput">
                                            <input type="radio" value="3" name="order_by" id="allNilaiRedemption">
                                            <label for="allNilaiRedemption" class="radioBtn">All Unit</label>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    <span class="control-label">
                                        <label class="account_id" for="account_id">Rekening Penerima: </label>
                                    </span>
                                    <span class="controls">
                                        ...
                                        <div class="divTableBody">
                                            ...
                                            <div class="divTableRow">
                                                <div class="divTableCell">
                                                    ...
                                                    <span id="bank_branch" class="value">xxx</span>
                                                </div>
                                            </div>
                                            <div class="divTableRow">
                                                <div class="divTableCell">
                    ...
                    <div id="entryRedBtn" class="divTable">
                        <div class="divTableBody">
                            <div class="divTableRow">
                                <div class="divTableCell">
                                    <div class="wrapBtn">
    ...
    <script src="<?= base_url() ?>js/page/redeem.js" type="text/javascript"></script>
