            ...
            <div class="moduletable_menu">
                <div class="modinside">
                    <ul class="menu">
                        ...
                        <li class="item-102">
                            <a href="nabung.html" target="_blank"><span class="text">Nabung Investasi Yuk</span></a>
                        </li>
                        <li class="item-103">
                            <a href="http://avrist-am.com/contact-us" target="_blank"><span class="text">Hubungi Kami</span></a>
                        </li>
                        <li class="item-107">
                            <a href="#"><span class="text">Masuk</span></a>
                        </li>
                    </ul>
                    <div class="clean"></div>
                </div>
                        ...
                        <div class="moduletable slideshow">
                            <div class="modinside">
                                <div class="slideshowck slideshow camera_wrap camera_amber_skin" id="camera_wrap_1">
                                    <div data-thumb="images/th/microsyariah_th.jpg" data-src="images/microsyariah.jpg">
                                    </div>
                                    <div data-thumb="images/th/slide-02_th.jpg" data-src="images/slide-02.jpg">
                                    ...
                                    <div data-thumb="images/th/slide-01_th.jpg" data-src="images/slide-01.jpg">
                                        <div class="camera_caption fadeFromBottom">
